...
export default function HomePage() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-bg text-white font-sans selection:bg-orange-500 selection:text-black">
            ...
            <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-5 pt-15 sm:px-8 sm:pt-10 md:px-10">
                <section
                    id="home"
                ...
                <section id="education" className="scroll-mt-24 py-16 md:py-20" aria-labelledby="education-title">
                    <div className="mb-10 text-center md:mb-12">
                        <h2 id="education-title" className="mb-3 text-3xl font-bold tracking-tight sm:text-4xl">
                            {t.education.title}
                        </h2>
                    ...
                    <article className="mx-auto flex max-w-4xl flex-col items-center justify-between gap-6 rounded-2xl border border-white/5 bg-surface p-6 shadow-lg transition-colors duration-300 hover:border-orange-500/30 sm:flex-row sm:p-8 sm:text-left">
                        <div className="flex flex-col items-center gap-5 sm:flex-row">
                            ...
                            <div className="text-center sm:text-left">
                                ...
                                <p className="mt-1 text-sm text-orange-400">{t.education.year}</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl border border-white/10 bg-bg px-5 py-2.5 shadow-inner transition-colors hover:border-orange-500/50">
                            <p className="whitespace-nowrap text-lg font-bold text-orange-500">{t.education.gpa}</p>
                        </div>
                    </article>
                </section>

                <section id="tech-stack" className="scroll-mt-24 py-16 md:py-20" aria-labelledby="tech-stack-title">
                    <div className="mb-10 text-center md:mb-12">
                        <h2 id="tech-stack-title" className="mb-3 text-3xl font-bold tracking-tight sm:text-4xl">
                            {t.skills.title}
                        </h2>
                        <div className="mx-auto mb-5 h-1.5 w-12 rounded-full bg-orange-500"></div>
                        <p className="mx-auto max-w-xl text-sm leading-relaxed text-gray-400 sm:text-base">
                ...
                <section id="experience" className="scroll-mt-24 py-16 md:py-20" aria-labelledby="experience-title">
                    <div className="mb-10 text-center md:mb-12">
                        <h2 id="experience-title" className="mb-3 text-3xl font-bold tracking-tight sm:text-4xl">
                            {t.experience.title}
                        </h2>
                        <div className="mx-auto mb-5 h-1.5 w-12 rounded-full bg-orange-500"></div>
                        <p className="mx-auto max-w-xl text-sm leading-relaxed text-gray-400 sm:text-base">
                                    ...
                                    <div className="flex flex-col gap-6 md:flex-row md:gap-8">
                                        <div className="flex shrink-0 items-start gap-4 md:w-[35%] lg:w-[30%]">
                                            ...
                                            <div className="flex flex-col pt-1">
                                                ...
                                                <p className="mb-3 text-sm font-semibold text-orange-500">{exp.company}</p>
                ...
                <section id="projects" className="scroll-mt-24 py-16 md:py-20" aria-labelledby="projects-title">
                    <div className="mb-10 text-center md:mb-12">
                        <h2 id="projects-title" className="mb-3 text-3xl font-bold tracking-tight sm:text-4xl">{t.projects.title}</h2>
                        <div className="mx-auto mb-5 h-1.5 w-12 rounded-full bg-orange-500"></div>
                        <p className="mx-auto max-w-xl text-sm leading-relaxed text-gray-400 sm:text-base">
                ...
                <section id="connect" className="scroll-mt-24 py-16 pb-24 md:py-20" aria-labelledby="connect-title">
                    <div className="mb-10 text-center md:mb-12">
                        <h2 id="connect-title" className="mb-3 text-3xl font-bold tracking-tight sm:text-4xl">
                            {t.connect.title}
                        </h2>
                        <div className="mx-auto mb-5 h-1.5 w-12 rounded-full bg-orange-500"></div>
                        <p className="mx-auto max-w-xl text-sm leading-relaxed text-gray-400 sm:text-base">
